...
public class ParkingService {
	...
	public void processIncomingVehicle(Date dateIn) {
		try {
	...
	private String getVehichleRegNumber() throws Exception {
		...
		return this.inputReaderUtil.readVehicleRegistrationNumber();
	}
	...
	public ParkingSpot getNextParkingNumberIfAvailable() {
		...
		try {
			ParkingType parkingType = this.getVehichleType();
			parkingNumber = this.parkingSpotDAO.getNextAvailableSlot(parkingType);
			if (parkingNumber > 0) {
	...
	private ParkingType getVehichleType() {
		...
		int input = this.inputReaderUtil.readSelection();
		switch (input) {
		case 1: {
